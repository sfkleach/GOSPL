...
section $-forall_match => nonmac forall_match nonmac endforall_match startfindall;

vars mymatchvars = nil; ;;; records variable bindings

vars pattern datum ttt nnn vvv sss savepmvars newproc;

define mymatch(pattern, datum);
    dlocal pattern datum ttt nnn vvv sss savepmvars newproc;
    mymatchvars -> sss;
loop:
...
vars FORALL_ENDLAB FORALL_LAB FORALL_VAR ;

define global syntax forall_match;
    dlocal FORALL_ENDLAB FORALL_LAB FORALL_VAR ;
